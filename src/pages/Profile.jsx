...
const Profile = () => {
  ...
  return (
    <div className="">
      <div className="h-20 pt-5 w-7/12 mx-auto">
      ...
      {watchlist.length === 0? 
        <div className=" h-100 flex items-center justify-center flex-col">
          <div className="flex flex-col items-center ">
            ...
            <h2 className="text-white montserrat text-xl mt-2">Your watchlist is empty</h2>
            <h2 className="text-gray-400 text-sm mt-1">Add movies to your watchlist to watch them later</h2>
            <Button
            onClick={browseBtnHandler}
            text="Browse Movies" classname="bg-red-500 text-sm py-3 px-5 mt-5  text-white" />
          </div>
        </div>
    :
